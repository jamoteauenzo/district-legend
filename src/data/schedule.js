...
export const WEEKS = [
  {
    ...
    date: 'Fin juillet',
    steps: [
      { scene: 'Cards', data: { deck: 'bizutage' }, jour: 'MARDI 18H45', titre: 'Le vestiaire : ton arrivée' },
      ...
      { scene: 'Cards', data: { deck: 'samedi' }, jour: 'SAMEDI 23H', titre: 'Samedi soir' },
  ...
  },
  {
    ...
    steps: [
      ...
      { scene: 'Cards', data: { deck: 'veilleCoupe' }, jour: 'SAMEDI', titre: 'La veille de la Coupe' },
